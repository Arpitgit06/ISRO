...
export default function PipelineWireframe({ uploadProgress, isProcessing }) {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--accent-dim)', paddingBottom: '12px' }}>
        ...
        <div style={{ 
          ...
          <span style={{ fontSize: '11px', fontWeight: 600, color: 'var(--accent-color)', letterSpacing: '0.05em' }}>
      ...
      <div style={{ 
        ...
        {/* Wireframe Grid Background (Theme tint) */}
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'linear-gradient(var(--accent-glow) 1px, transparent 1px), linear-gradient(90deg, var(--accent-glow) 1px, transparent 1px)', backgroundSize: '20px 20px', pointerEvents: 'none' }} />
        ...
        <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
          ...
          <line 
            ...
            stroke={currentStage >= 2 ? 'var(--accent-color)' : '#222222'} 
            strokeWidth="1.5"
            strokeDasharray="5,5"
          ...
          <path 
            ...
            fill="none" 
            stroke={currentStage >= 3 ? 'var(--accent-color)' : '#222222'} 
            strokeWidth="1.5" 
            strokeDasharray="5,5"
          ...
          <path 
            ...
            fill="none" 
            stroke={currentStage >= 4 ? 'var(--accent-color)' : '#222222'} 
            strokeWidth="1.5" 
            strokeDasharray="5,5"
          ...
          <line 
            ...
            stroke={currentStage >= 5 ? 'var(--accent-color)' : '#222222'} 
            strokeWidth="1.5" 
            strokeDasharray="5,5"
        ...
        <div style={{
          ...
          background: currentStage === 1 ? 'var(--accent-glow)' : 'rgba(0, 0, 0, 0.85)',
          border: `1px solid ${currentStage === 1 ? 'var(--accent-color)' : currentStage > 1 ? 'var(--accent-dim)' : '#222222'}`,
          boxShadow: currentStage === 1 ? '0 0 12px var(--accent-glow)' : 'none',
          display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 12px',
          transition: 'all 0.3s ease', zIndex: 5
        }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '10px', fontWeight: 700, color: currentStage >= 1 ? 'var(--accent-color)' : '#475569' }}>01 / PREPROCESS</span>
            {currentStage > 1 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold' }}>✓ COMPLETE</span>}
            {currentStage === 1 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold', animation: 'pulse 1s infinite' }}>● RUNNING</span>}
          </div>
        ...
        <div style={{
          ...
          width: '210px', height: '50px', borderRadius: '2px',
          background: currentStage === 2 ? 'var(--accent-glow)' : 'rgba(0, 0, 0, 0.85)',
          border: `1px solid ${currentStage === 2 ? 'var(--accent-color)' : currentStage > 2 ? 'var(--accent-dim)' : '#222222'}`,
          boxShadow: currentStage === 2 ? '0 0 12px var(--accent-glow)' : 'none',
          display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 12px',
          transition: 'all 0.3s ease', zIndex: 5
        }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '10px', fontWeight: 700, color: currentStage >= 2 ? 'var(--accent-color)' : '#475569' }}>02 / ENCODER BACKBONE</span>
            {currentStage > 2 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold' }}>✓ COMPLETE</span>}
            {currentStage === 2 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold', animation: 'pulse 1s infinite' }}>● EXTRACTING</span>}
          </div>
        ...
        <div style={{
          ...
          background: currentStage === 3 ? 'var(--accent-glow)' : 'rgba(0, 0, 0, 0.85)',
          border: `1px solid ${currentStage === 3 ? 'var(--accent-color)' : currentStage > 3 ? 'var(--accent-dim)' : '#222222'}`,
          boxShadow: currentStage === 3 ? '0 0 12px var(--accent-glow)' : 'none',
          display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 10px',
          transition: 'all 0.3s ease', zIndex: 5
        }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '9px', fontWeight: 700, color: currentStage >= 3 ? 'var(--accent-color)' : '#475569' }}>03A / SUPER-RES</span>
            {currentStage > 3 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold' }}>✓</span>}
            {currentStage === 3 && <span style={{ color: 'var(--accent-color)', fontSize: '8px', animation: 'pulse 1s infinite' }}>● RUN</span>}
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '9px', fontWeight: 700, color: currentStage >= 3 ? 'var(--accent-color)' : '#475569' }}>03B / COLORIZER</span>
            {currentStage > 3 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold' }}>✓</span>}
            {currentStage === 3 && <span style={{ color: 'var(--accent-color)', fontSize: '8px', animation: 'pulse 1s infinite' }}>● RUN</span>}
          </div>
        ...
        <div style={{
          ...
          width: '210px', height: '50px', borderRadius: '2px',
          background: currentStage === 4 ? 'var(--accent-glow)' : 'rgba(0, 0, 0, 0.85)',
          border: `1px solid ${currentStage === 4 ? 'var(--accent-color)' : currentStage > 4 ? 'var(--accent-dim)' : '#222222'}`,
          boxShadow: currentStage === 4 ? '0 0 12px var(--accent-glow)' : 'none',
          display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 12px',
          transition: 'all 0.3s ease', zIndex: 5
        }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '10px', fontWeight: 700, color: currentStage >= 4 ? 'var(--accent-color)' : '#475569' }}>04 / DETECTION HEAD</span>
            {currentStage > 4 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold' }}>✓ COMPLETE</span>}
            {currentStage === 4 && <span style={{ color: 'var(--accent-color)', fontSize: '9px', fontWeight: 'bold', animation: 'pulse 1s infinite' }}>● DETECTING</span>}
          </div>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <span style={{ fontSize: '9.5px', fontWeight: 700, color: 'var(--accent-color)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
